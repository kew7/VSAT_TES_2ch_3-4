...
BEGIN_MESSAGE_MAP(CMirag_VvodDlg, CDialog)
...
HCURSOR CMirag_VvodDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}


void CAbonentDlg::OnMesCount(int def, LPARAM Block ) 
{
